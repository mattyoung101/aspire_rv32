...
% \subsection{ASIC tapeout using OpenLane}
...
% synthesis tool would be a mix of Yosys and OpenLane for place and route. This would be extremely complex to 
% verify, as while open source tools \textit{can} run a full tapeout, they don't have good power and thermal 
% analysis tools.
